...
featured: true
summary: "Production message generation platform supporting a large active commercial mortgage loan portfolio, driving Genworth’s vendor-to-in-house CML accounting migration with automated reconciliation and daily production execution."
highlights:
...
impact:
  - "Supports a large active commercial mortgage loan portfolio across the full transaction lifecycle: payments, fees, payoffs, and adjustments"
