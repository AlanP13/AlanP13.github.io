...
featured: true
summary: "Metadata-driven message generation platform in Azure Synapse covering a broad derivatives portfolio spanning options, futures, and swaps, extensible to additional asset classes without platform changes, and validated as a cross-cloud portability POC."
highlights:
...
impact:
  - "Generates SMF and transaction messages for a broad derivatives portfolio spanning options, futures, and swaps from a single unified platform"
