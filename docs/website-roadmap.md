...
| ID-004 | [ ] | P1 | XS | **Fix ITHENA work mode — remove "In-Person"** — `work-ithena-fs.mdx` `location` currently "Richmond, VA (In-Person)"; work mode is unverified. Safe form: "Richmond, VA". | Canonical: ITHENA-001. Keep title "Full Stack Developer Intern" — it is already correct. |
| ID-005 | [ ] | P1 | XS | **Add Student Assistant timeline entry** — Create `src/content/timeline/work-iit-student-assistant.mdx`. Lower visual priority than Genworth/ITHENA entries (use `order: 5` or lower). | Canonical: IIT-SA-001. Aug 2021 – May 2023. |
| ID-006 | [ ] | P1 | XS | **IIT BS degree — add start date** — `edu-bs.mdx` shows only "August 2023". Canonical: "August 2019 – August 2023". | Resume-confirmed. |
| ID-007 | [ ] | P1 | XS | **IIT MS degree — add start date** — `edu-ms.mdx` shows only "August 2023". Start date disputed: RESUME-0728 says May 2022; older CareerOS record had August 2022. **Blocked on transcript verification.** Do not update until official IIT transcript or enrollment record confirms. | See `docs/career-os.md` EDU-003 for dispute detail. |
| ID-008 | [ ] | P1 | XS | **Fix CFA cert MDX — wrong title and status** — `foundations-in-investments.mdx`: title reads "Foundations of Investment" (wrong); status is "in-progress" (wrong). Canonical: title "Investment Foundations® Certificate", `status: "earned"`, `dateObtained: "2026-07"`, `credentialId: "189900608"`. Verify credentialUrl at cfainstitute.org. | Source: physical certificate PDF. |
| ID-009 | [ ] | P1 | XS | **Verify and fix AWS cert MDX title** — `aws-certified-5-certifications.mdx` says "5 Certifications"; physical Udemy certificate says "4 Certifications!". **Before changing:** confirm whether the discrepancy is a course bundle title vs. actual AWS credential count — the banner count may refer to a campaign rather than discrete exams. Enumerate the specific AWS domains covered (Solutions Architect, SysOps, Developer, Cloud Practitioner?) and update the MDX title + skills list to reflect the confirmed scope. | Source: physical certificate PDF says "4 Certifications!" — needs semantic verification. |
...
| ID-011 | [ ] | P1 | S | **Add three new certification MDX files** — (1) `qualys-vmdr.mdx`: "Vulnerability Management Detection and Response", Qualys, earned 2026-07-28, expires 2028-07-27, **HIGHEST confidence** (physical certificate verified); (2) `neo4j-certified-professional.mdx`: Neo4j, Aug 2026, ID 599d588d-8706-44bf-9707-59c5bb61a5b9, **HIGH confidence** (LinkedIn-sourced only — no physical cert PDF yet); (3) `neo4j-graph-data-science.mdx`: Neo4j, Aug 2026, ID 0285db3f-4f77-4501-92c8-c48ebe19d30d, **HIGH confidence** (LinkedIn-sourced only). Add Neo4j cert PDFs to `manual/_extracted/Certifications/` when available to upgrade confidence to HIGHEST. | Qualys: CERT-PDF verified. Neo4j: LINKEDIN-PDF only — different evidence tier. |
